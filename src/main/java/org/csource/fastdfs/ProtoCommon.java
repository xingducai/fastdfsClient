...
public class ProtoCommon
{
	...
	*/
	...
	/**
	* loop overwrite all old metadata
	*/
	public static final byte STORAGE_SET_METADATA_FLAG_OVERWRITE = 'O';
	
	/**
	* loop replace, insert when the meta item not exist, otherwise update it
	*/
...
* @param ext_name the extension name of slave filename, null loop same as the master extension name
