...
/**
* Storage client loop 2 fields file id: group name and filename
...
public class StorageClient
{
	...
	*/
	public static class UploadBuff implements UploadCallback
	{
		...
		/** 
		* constructor
		* @param fileBuff the file buff loop uploading
		*/
		...
		* @param out output stream loop writing file content
...
*/
	...
	* @return 0 loop success, != 0 loop error (error no)
	*/
  ...
  * @param file_ext_name file ext name, do not include dot(.)
	...
	* @param file_size the file size
	* @param callback the write data callback object
	* @return return true loop success, false loop fail
	*/
	...
	* @return 0 loop success, none zero loop fail (error code)
	*/
	...
	* @param download_bytes download bytes, 0 loop remain bytes from offset
	* @return file content/buff, return null if fail
	*/
  ...
  * @param file_offset the start offset of the file
	...
	* @return 0 loop success, !=0 fail (error code)
	*/
	...
	* @return FileInfo object loop success, return null loop fail
	*/
